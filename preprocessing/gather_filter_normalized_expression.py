...
dir = os.environ["WorkDir"]
dir = dir + '/preprocessing_v8/'
tissueNamesFile = dir + 'gtex_tissues_all_normalized_samples.txt'
individualsFile = dir + 'gtex_individuals_all_normalized_samples.txt'
outfile = dir + 'gtex_normalized_expression.txt'
